...
SECRET_KEY = "django-insecure-2lo6u9$tm!q_ulxvtpg#r^@p8*i4m6e+f-6&a%&x#kf)ru4r3h"
...
DATABASES['default'] = dj_database_url.parse("postgres://apaar:VZxKuPndcJlckwJpqCccOy1wFJphSjUI@dpg-cm4r7jnqd2ns73elovtg-a.singapore-postgres.render.com/sow")
